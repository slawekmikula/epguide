...
class  ShowWithSubtitleWithDetailsTest(unittest.TestCase):
    ...
    def testShowWithSubtitleWithDetails(self):
        ...
        event = TelemanEvent(parser_options, channel, title, main_category, category, desc, time_start, time_end, url, details=details)
        self.assertEqual(event.get_title(), u'Rodzinka.pl [od 12 lat]')# with original title, year and age
        self.assertEqual(event.get_subtitle(), "Zachcianki")
        self.assertEqual(event.get_episode_num(), "80")
        ...
        self.assertEqual(event.get_title(), u'Rodzinka.pl [od 12 lat]')# with year and age
        self.assertEqual(event.get_subtitle(), "Zachcianki")
        self.assertEqual(event.get_episode_num(), "80")
        ...
        self.assertEqual(event.get_title(), u'Rodzinka.pl [od 12 lat]') # with original title and age
        self.assertEqual(event.get_subtitle(), "Zachcianki")
        self.assertEqual(event.get_episode_num(), "80")
        ...
        self.assertEqual(event.get_title(), u'Rodzinka.pl [od 12 lat]') # with age
        self.assertEqual(event.get_subtitle(), "Zachcianki")
        self.assertEqual(event.get_episode_num(), "80")
